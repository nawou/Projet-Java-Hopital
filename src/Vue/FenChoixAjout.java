 ...
 * @author nawellalioui
 */
public class FenChoixAjout extends javax.swing.JFrame implements ActionListener{

    /**
     * Creates new form FenChoixAjout
     */
    public FenChoixAjout() {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Voulez-vous ajouter un employé ou un patient ?");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FenChoixAjout.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FenChoixAjout().setVisible(true);
            }
        });
    }
