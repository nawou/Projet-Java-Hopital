...
public class Connexion {
   ...
   public void ajouterTable(String table) {
    ...
    /**
     * Methode qui rempli le champs des attributs 
     * @param table
     * @return 
     * @throws java.sql.SQLException 
     */
    public ArrayList<ArrayList<String>> remplirChampsAttribut(String table) throws SQLException{
        // récupération de l'ordre de la requete
        rset = stmt.executeQuery("SELECT * FROM " + table);
        ...
        // Retourner l'ArrayList deux dimensions
        return liste;
    }
